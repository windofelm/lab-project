	...
	<div class="qodef-blog-list-item-inner">
		<div class="qodef-item-image clearfix">
			<a href="http://startit.select-themes.com/amanda-mills/">
				<img width="150" height="150" src="http://startit.select-themes.com/wp-content/uploads/2015/04/b-image-2b.jpg" class="attachment-full size-full wp-post-image" alt="b-image-2b" />				
			</a>
		</div>
		<div class="qodef-item-text-holder">			
			<h6 class="qodef-item-title ">
	...
	<div class="qodef-blog-list-item-inner">
		<div class="qodef-item-image clearfix">
			<a href="http://startit.select-themes.com/justin-pearson/">
				<img width="150" height="150" src="http://startit.select-themes.com/wp-content/uploads/2015/04/b-image-4a.jpg" class="attachment-full size-full wp-post-image" alt="b-image-4a" />				
			</a>
		</div>
		<div class="qodef-item-text-holder">			
			<h6 class="qodef-item-title ">
	...
	<div class="qodef-blog-list-item-inner">
		<div class="qodef-item-image clearfix">
			<a href="http://startit.select-themes.com/tech-conference-2017/">
				<img width="150" height="150" src="http://startit.select-themes.com/wp-content/uploads/2015/04/b-image-3a.jpg" class="attachment-full size-full wp-post-image" alt="b-image-3a" />				
			</a>
		</div>
		<div class="qodef-item-text-holder">			
			<h6 class="qodef-item-title ">
...
<form action="/about-us/#wpcf7-f1334-o1" method="post" class="wpcf7-form" novalidate="novalidate">
...
<script type='text/javascript' src='//startit.select-themes.com/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min.js'></script>
<script type='text/javascript' src='//startit.select-themes.com/wp-content/plugins/woocommerce/assets/js/jquery-cookie/jquery.cookie.min.js'></script>
<script type='text/javascript'>
/* <![CDATA[ */
