...
<div class="vc_empty_space" style="height: 40px"><span class="vc_empty_space_inner"></span></div>
	...
	<div class="qodef-elements-holder-item-inner">
		<div class="qodef-elements-holder-item-content qodef-elements-holder-custom-581224" style="padding: 0 0 0 0">
						
	<div class="wpb_single_image wpb_content_element vc_align_left">
		
		<figure class="wpb_wrapper vc_figure">
			<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="600" height="450" src="./assets/img/About-us-Single-image-2.jpg" class="vc_single_image-img attachment-full" alt="m" srcset="http://startit.select-themes.com/wp-content/uploads/2015/10/About-us-Single-image-2.jpg 600w, http://startit.select-themes.com/wp-content/uploads/2015/10/About-us-Single-image-2-300x225.jpg 300w" sizes="(max-width: 600px) 100vw, 600px"></div>
		</figure>
	</div>
		</div>
	</div>
...
<div class="vc_empty_space" style="height: 40px"><span class="vc_empty_space_inner"></span></div>
	...
	<div class="qodef-elements-holder-item-inner">
		<div class="qodef-elements-holder-item-content qodef-elements-holder-custom-709472" style="padding: 0 0 0 0">
						
	<div class="wpb_single_image wpb_content_element vc_align_left">
		
		<figure class="wpb_wrapper vc_figure">
			<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="600" height="450" src="./assets/img/About-us-Single-image-3.jpg" class="vc_single_image-img attachment-full" alt="m" srcset="http://startit.select-themes.com/wp-content/uploads/2015/10/About-us-Single-image-3.jpg 600w, http://startit.select-themes.com/wp-content/uploads/2015/10/About-us-Single-image-3-300x225.jpg 300w" sizes="(max-width: 600px) 100vw, 600px"></div>
		</figure>
	</div>
		</div>
	</div>
...
<div class="qodef-progress-bar">
	<h6 class="qodef-progress-title-holder clearfix">
		...
		<span class="qodef-progress-number-wrapper qodef-floating qodef-floating-outside " style="opacity: 1;">
			<span class="qodef-progress-number" style="left: 75%;">
				<span class="qodef-percent">75</span>	
									<span class="qodef-down-arrow"></span>
							</span>
		</span>
	</h6>
	<div class="qodef-progress-content-outer " style="background-color:#ffffff">
		<div data-percentage="75" class="qodef-progress-content" style="width: 75%;"></div>
	</div>
</div>	<div class="qodef-progress-bar">
	<h6 class="qodef-progress-title-holder clearfix">
		<span class="qodef-progress-title">Coding</span>
		<span class="qodef-progress-number-wrapper qodef-floating qodef-floating-outside " style="opacity: 1;">
			<span class="qodef-progress-number" style="left: 64%;">
				<span class="qodef-percent">64</span>	
									<span class="qodef-down-arrow"></span>
							</span>
		</span>
	</h6>
	<div class="qodef-progress-content-outer " style="background-color:#ffffff">
		<div data-percentage="64" class="qodef-progress-content" style="width: 64%;"></div>
	</div>
</div>	<div class="qodef-progress-bar">
	<h6 class="qodef-progress-title-holder clearfix">
		<span class="qodef-progress-title">PR &amp; Marketing</span>
		<span class="qodef-progress-number-wrapper qodef-floating qodef-floating-outside " style="opacity: 1;">
			<span class="qodef-progress-number" style="left: 83%;">
				<span class="qodef-percent">83</span>	
									<span class="qodef-down-arrow"></span>
							</span>
		</span>
	</h6>
	<div class="qodef-progress-content-outer " style="background-color:#ffffff">
		<div data-percentage="83" class="qodef-progress-content" style="width: 83%;"></div>
	</div>
...
<div class="qodef-team main-info-below-image">
	<div class="qodef-team-inner">
				...
				<img src="./assets/img/team-1-home-main.jpg" alt="qodef-team-image">
...
<div class="qodef-team main-info-below-image">
	<div class="qodef-team-inner">
					<div class="qodef-team-image">
				<img src="./assets/img/team-2-home-main.jpg" alt="qodef-team-image">
				<div class="qodef-team-position-holder">
					<div class="qodef-circle-animate"></div>
					<div class="qodef-team-position-icon">
...
<div class="qodef-team main-info-below-image">
	<div class="qodef-team-inner">
					<div class="qodef-team-image">
				<img src="./assets/img/team-3-home-main.jpg" alt="qodef-team-image">
				<div class="qodef-team-position-holder">
					<div class="qodef-circle-animate"></div>
					<div class="qodef-team-position-icon">
...
<div class="qodef-team main-info-below-image">
	<div class="qodef-team-inner">
					<div class="qodef-team-image">
				<img src="./assets/img/team-4-home-main.jpg" alt="qodef-team-image">
				<div class="qodef-team-position-holder">
					<div class="qodef-circle-animate"></div>
					<div class="qodef-team-position-icon">
...
</div></div></div></div></div></div><div class="vc_row wpb_row vc_row-fluid qodef-section qodef-content-aligment-left" style=""><div class="clearfix qodef-full-section-inner"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="qodef-carousel-holder with_navigation clearfix"><div class="qodef-carousel owl-carousel owl-theme" data-items="6" data-navigation="yes" style="opacity: 1; display: block;"><div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 4560px; left: 0px; display: block; transition: all 1000ms ease; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-1.png" alt="Home 2 C1">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-2.png" alt="Home 2 C2">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-3.png" alt="Home 2 C3">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-4.png" alt="Home 2 C4">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-5.png" alt="Home 2 C5">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-6.png" alt="Home 2 C6">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-1.png" alt="Home 2 C7">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-2.png" alt="Home 2 C8">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-3.png" alt="Home 2 C9">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-4.png" alt="Home 2 C10">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-5.png" alt="Home 2 C11">
                    </span>
                                        	</div></div><div class="owl-item" style="width: 190px;"><div class="qodef-carousel-item-holder">
	                                            <span class="qodef-carousel-first-image-holder  qodef-image-zoom">
                        <img src="./assets/img/Home-2-Carousel-6.png" alt="Home 2 C12">
                    </span>
                                        	</div></div></div></div><div class="owl-controls clickable"><div class="owl-buttons"><div class="owl-prev"><span class="qodef-prev-icon"><i class="fa fa-chevron-left"></i></span></div><div class="owl-next"><span class="qodef-next-icon"><i class="fa fa-chevron-right"></i></span></div></div></div></div></div></div></div></div></div></div>
							</div>
</div>
